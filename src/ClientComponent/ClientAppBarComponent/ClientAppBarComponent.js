...
import Synxalogo from '../ViewProfiles/images/synxa logo.png';
...
const navItems = [
  { name: "Requirements", icon: <PreviewIcon />, path: "post-requirements" },
  { name: "View Profiles", icon: <AccountCircleIcon />, path: "view-profiles" },
];

export default function ClientAppBarComponent() {
          ...
          <Box>
            ...
            <List sx={{ background: "#1c1c1c1A", color: "#fff" }}>
              <Box sx={styles.navItem}>
                <Typography variant="body1" style={styles.clientHeader}>Clients</Typography>
              </Box>
              {navItems.map((item) => (
