...
const navItems = [
  { name: "Apply for positions", icon: <PreviewIcon />, path: "apply-for-positions" },
  { name: "Status of positions", icon: <AccountCircleIcon />, path: "status-of-positions" },
];

const RecruiterAppBarComponent = () => {
          ...
          <Box>
            ...
            <List sx={{ background: "#1c1c1c1A", color: "#fff" }}>
              <Box sx={styles.navItem}>
                <Typography variant="body1" style={styles.clientHeader}>Recruiter</Typography>
              </Box>
              {navItems.map((item) => (
...
export default RecruiterAppBarComponent